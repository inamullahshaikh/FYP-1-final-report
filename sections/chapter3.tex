...
\subsubsection*{3.4.3\quad Data Flow Diagrams (DFDs)}
...
Level 0 provides an overview of the main system interactions, while Level 1 elaborates on internal data processing — especially how attendance tagging, face verification, and behavior monitoring are interconnected.
...
Figure~\ref{fig:dfd-level1} expands the ForeSyte process into its major internal modules: Face Recognition and Attendance Tagging, Cheating Detection Engine, Invigilator Monitoring, and Report Generation. Data from entry-point cameras are first processed to verify and tag each student; this tag is then propagated through subsequent modules for seat mapping, activity analysis, and reporting.

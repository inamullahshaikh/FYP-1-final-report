...
The architecture follows a \textbf{multi-tiered layered style}, combining elements of the \textbf{MVC (Model-View-Controller)} pattern. The front-end handles input, report generation and visualization, the back-end processes and analyzes video frames, and the data management layer ensures persistence and retrieval of information. Reports are then generated for administrators and investigators. This decomposition ensures that the AI detection logic, data storage, and user interfaces remain loosely coupled and independently upgradable.

Figure \ref{fig:architecture} illustrates the high-level architecture of the system, showing the main subsystems and their interactions.

\begin{figure}
    \centering
    \caption{High-Level Architectural Design of the ForeSyte AI Exam Surveillance System}
    \includegraphics[width=\textwidth]{sections/architecture.png}

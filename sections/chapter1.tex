...
each detected activity is accurately linked to the correct student through seat mapping, similar to approaches in modern proctoring systems \cite{masud2025cheating_detection, arumugam2025smart_invigilation}. 
...
\begin{enumerate}
    ...
    \item \textbf{Seating Plan Integration:} Links violations to student seating layouts to ensure accurate identification of candidates involved in flagged incidents.
\end{enumerate}
...
\begin{enumerate}
    ...
    \item \textbf{Seat Mapping:} Maps detected activities to seating plans for accurate violation reporting, ensuring each activity is linked to the correct student seat.

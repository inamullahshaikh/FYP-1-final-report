...
% Define keywords environment if not already defined
...
\begin{keywords}
Exam Surveillance, AI-Powered Monitoring, Computer Vision, Deep Learning, Student Behavior Detection, Invigilator Monitoring, Cheating Detection, FastAPI, React, Dashboard Systems, Video Processing, RESTful API, PostgreSQL, MongoDB, Seat Mapping, Academic Integrity
\end{keywords}
